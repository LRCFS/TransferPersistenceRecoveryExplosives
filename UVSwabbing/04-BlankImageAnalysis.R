### Blank Image Analysis - Analyze Blank threshold results ###
...
for (file in BlankThresholdResults_files) {
  ...
  # Extract the filename without extension and remove "_Blank" suffix
  results_name <- tools::file_path_sans_ext(basename(file))
  results_name <- sub("_Blank$", "", results_name)
