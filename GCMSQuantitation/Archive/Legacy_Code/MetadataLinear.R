...
# =========================================================
# GC-MS PETN/RDX Quantification Script (Linear Calibration)
# =========================================================
#
...
#  - Linear calibration (analyte/IS ratio vs concentration)
...
for (analyte_name in names(analytes)) {
  ...
  for (i in seq_along(CalSets)) {
    ...
    for (method_name in names(cal_methods)) {
      ...
      # Build linear model dynamically
