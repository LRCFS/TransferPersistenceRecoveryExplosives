...
setwd("C:/Users/A Bruce - User/Documents/ClaudeSpace/GCMSQuantitation")
...
if (!file.exists("Code/04_CollateStudyResults.R")) {
  stop("Code/04_CollateStudyResults.R not found.")
}
...
process_dataset <- function(dataset_path, dataset_name) {
  ...
  # Override DataFolder in this environment
...
tryCatch({
  source("Code/04_CollateStudyResults.R")
